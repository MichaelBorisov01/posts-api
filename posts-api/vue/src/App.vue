<template>
  <v-app class="app">
    <v-app-bar app>
      ...
      <v-toolbar-title class="title">post-api</v-toolbar-title>

      <v-text-field solo dense rounded prepend-inner-icon="mdi-magnify" v-model="searchQuery" @input="setSearchQuery"
        outlined label="Поиск по названию..." style="max-width: 500px; margin: 8px auto auto;" />
